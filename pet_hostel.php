...
<div class="container">
		<div class="register">
		<center><p1>PET Hostel</p1></center>	<br>	
...
//AIzaSyDno9pGrZNYY217OgLwk3iTJ95szCPkVT0"
...
var searchUrl = 'http://ranou.esy.es/PETSHOP/sample.php?lat=' + lat + '&lng=' + lng + '&radius=' + radius;
     ...
     downloadUrl(searchUrl, function(data) {
       ...
       for (var i = 0; i < markerNodes.length; i++) {
         var name = markerNodes[i].getAttribute("hname");
...
<div>
<input type="submit" value="Register" onclick="window.location.href='http://ranou.esy.es/PETSHOP/hostel_register.php'" name="submit"/>
</div>
  </body>
</html>
