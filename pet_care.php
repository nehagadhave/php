...
<div class="container">
		<div class="register">
		<center><p1>PET Hospital</p1></center>	<br>	
...
var searchUrl = 'http://ranou.esy.es/PETSHOP/sample1.php?lat=' + lat + '&lng=' + lng + '&radius=' + radius;
...
<div>
<input type="submit" value="Register" onclick="window.location.href='http://ranou.esy.es/PETSHOP/hospital_register.php'" name="submit"/>
</div>
  </body>
</html>
