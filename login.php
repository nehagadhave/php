...
$hash1=$_REQUEST['hash'];
          ...
          $search1 = "SELECT email, hash, active FROM user WHERE email='".$email1."' AND hash='".$hash1."' AND active='0'"; 
        $result1 = $con->query($search1);

	if(mysqli_num_rows($result1)>0){
		// We have a match, activate the account
		$update=$con->query("UPDATE user SET active='1' WHERE email='".$email1."' AND hash='".$hash1."' AND active='0'");
        }
...
<div class="container">
		<div class="account">
		<center><p1>Account</p1></center>
		<div class="account-pass">
		<div class="col-md-7 account-top">  <?php if(!empty($msg)) echo $msg; else echo "<error>(Please Login)</error>"?>
		...
		<div class="col-md-5 left-account ">
			<a href="single.html"><img class="img-responsive " src="images/newpet.jpg" alt=""></a>
