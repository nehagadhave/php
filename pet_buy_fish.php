...
var searchUrl = 'http://ranou.esy.es/PETSHOP/fish_sample5.php?lat=' + lat + '&lng=' + lng + '&radius=' + radius;
...
<select id="browsers">
    ...
    <option value="Wahoo"> Wahoo <dd/option>
    <option value="Blue tang surgeonfish"> Blue tang surgeonfish</option>
    <option value="Eyestripe surgeonfish"> Eyestripe surgeonfish</option>
    <option value="Japan surgeonfish">Japan surgeonfish</option>
    <option value="Blackstripe surgeonfish">Blackstripe surgeonfish</option>
    <option value="Arabian surgeonfish"> Arabian surgeonfish</option>
    <option value="Spotted eagle ray">Spotted eagle ray</option>
    <option value="    Sturgeon poacher">Sturgeon poacher</option>
    <option value="    Island kelpfish">Island kelpfish</option>
    <option value="    Barrier reef anemonefish">Barrier reef anemonefish</option>
    <option value="    Anemonefish">Anemonefish</option>
    <option value="    Red Saddleback Anemonefish">Red Saddleback Anemonefish</option>
    <option value="    Fire clownfish">Fire clownfish</option>
    <option value="    Clown anemonefish">Clown anemonefish</option>
    <option value="    Percula clownfish">Percula clownfish</option>
    <option value="    Pink anemonefish">Pink anemonefish</option>
    <option value="    Saddleback clownfish ">Saddleback clownfish </option>
    <option value="    Four-Eyed Fish">Four-Eyed Fish</option>
    <option value="    Sargo">Sargo</option>
    <option value="    Yellowtail grunt">Yellowtail grunt</option>
    <option value="    Penpoint gunnel">Penpoint gunnel</option>
    <option value="    Spotted-gill cardinalfish">Spotted-gill cardinalfish</option>
    <option value="    Guadalupe cardinalfish">Guadalupe cardinalfish</option>
    <option value="    Threadfin cardinalfish">Threadfin cardinalfish</option>
    <option value="    Southern orange-lined cardinalfish">Southern orange-lined cardinalfish</option>
    <option value="    Ornate Cowfish">Ornate Cowfish</option>
    <option value="    Orangelined cardinalfish">Orangelined cardinalfish</option>
    <option value="    Narrow-striped puffer">Narrow-striped puffer</option>
    <option value="    Guineafowl puffer">Guineafowl puffer</option>
    <option value="    Swallowtail damselfish">Swallowtail damselfish</option>
    <option value="    Bala shark">Bala shark</option>
    <option value="    Clown triggerfish">Clown triggerfish</option>
    <option value="    Topminnow">Topminnow</option>
    <option value="    Mexican hogfish">Mexican hogfish</option>
    <option value="    Mimic Roundhead">Mimic Roundhead</option>
    <option value="    Green jack">Green jack</option>
    <option value="    Blue-spotted jack">Blue-spotted jack</option>
