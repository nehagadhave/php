...
$query="select * from event_reg where date >= CURDATE()";
...
<div class="container">
	<div class="map-responsive">
				<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBgeEEZZHKCkYp0tPK6srhJMiFocLnRnnE"
...
if(category=="other" && catagory=="other")
{
      var html = "<b>" + name + "</b> <br/>" + address;
      var marker = new google.maps.Marker({
        map: map,
 ...
 var contentString =  '<div class="iw-content">' +
    ...
    <div> 
      <input type="button" id="addressInput" size="-1" />
 ...
 <body style="margin:0px; padding:0px;" onload="load()">
    <input type="button" class="view" onclick="searchLocations()" value="Search"/>
...
<!--------------------------------end------------------------->
		...
		<h4>Latest Events</h4><br>
                <marquee direction="up" >


<?php

$query1="select ename,catagory,date,place from event_reg where date >= CURDATE() and active=1";
...
?>
			...
			<div class="news">
				...
				<p><?php echo $place?></p>
				<div class="foot">
					<label><?php echo $ename?></label>
					<ul class="eye">
											 
						<li><span><i> </i></span></li>
						<li><a href="#"><i class="comment"> </i></a></li>
					</ul>
					<div class="clearfix"> </div>
				</div><br><br><br>
			</div>
...
?>
			...
			<a href="event_view.php" class="view">View All Events</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="event_register.php" class="view">Register Event</a></div>
		</div>
