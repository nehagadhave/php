...
var searchUrl = 'http://ranou.esy.es/PETSHOP/other_sample5.php?lat=' + lat + '&lng=' + lng + '&radius=' + radius;
     ...
     downloadUrl(searchUrl, function(data) {
       ...
       for (var i = 0; i < markerNodes.length; i++) {
         ...
         createMarker(image,latlng, name, address,ad_title,ad_description,price);
    ...
    function createMarker(image,latlng, name, address,ad_title,ad_description,price) {
